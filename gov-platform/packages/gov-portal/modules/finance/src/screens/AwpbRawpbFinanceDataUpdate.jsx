...
import { awpbRawpbFinanceDataUpdateSchema } from "../forms/awpb-rawpb-finance-data-update.schema";
...
export default function AwpbRawpbFinanceDataUpdate() {
  ...
  return (
    <DynamicForm
      schema={awpbRawpbFinanceDataUpdateSchema}
      formApiRef={formApiRef}
      onSubmit={handleSubmit}
      entityId="awpb-rawpb-finance-data-update"
      autosaveMs={800}
      ui={ui}
      validationSchema={awpbRawpbFinanceDataUpdateSchema}
      defaultsSchema={awpbRawpbFinanceDataUpdateSchema}
      output="flat"
