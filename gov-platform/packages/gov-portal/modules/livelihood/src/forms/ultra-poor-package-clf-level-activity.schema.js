export const ultraPoorPackageClfLevelActivitySchema = {
    $schema: "fe.v1",
    id: "ultra-poor-package-clf-level-activity",
    version: "1.0.0",
    title: "Ultra Poor Package CLF Level Activity",
    sections: [
        {
            id: "ultra-poor-package-clf-level-details",
            title: "Ultra Poor Package CLF Level Activity Details",
            fields: [
                {
                    id: "action",
                    type: "radio-group",
                ...
                //         labelKey: "name",
                //         valueKey: "id",
                //         query: { type: "father_husband" },
                //         dependsOn: ["values.memberId"],
                //         dependsOnHint: "Select SHG first",
                //         queryBuilder: (deps) => ({
                //             type: "father_husband",
                //             id: deps.shg,
