...
import { pashuSakhiOutcomeFormSchema } from "../forms/pashu-sakhi-outcome-form.schema";
...
export default function PashuSakhiOutcome() {
  ...
  return (
    <DynamicForm
      schema={pashuSakhiOutcomeFormSchema}
      formApiRef={formApiRef}
      onSubmit={handleSubmit}
      entityId="pashu-sakhi-outcome-form"
      autosaveMs={800}
      ui={ui}
      validationSchema={pashuSakhiOutcomeFormSchema}
      defaultsSchema={pashuSakhiOutcomeFormSchema}
      output="flat"
