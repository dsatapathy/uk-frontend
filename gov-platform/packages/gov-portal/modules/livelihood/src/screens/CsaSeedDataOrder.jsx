...
import { csaSeedOrderFormSchema } from "../forms/csa-seed-data-order.schema";
...
export default function CsaSeedDataOrder() {
  ...
  const handleSubmit = async (vals) => {
    try {
      ...
      show("Adding CSA Seed Data Order - please wait...");
      const payload = {
        module: "LIVELIHOOD_ACTIVITY_UPDATE",
        operation: "CREATE",
        formType: "CSA_SEED_DATA",
      ...
      submitMutation.mutate(
        { method, url: Url, payload },
        {
          onSuccess: (response) => {
            hide();
            enqueue({
              message: "CSA Seed Data Order added successfully.",
              severity: "success",
              duration: 6000,
            });
            ...
            const params = new URLSearchParams({
              status: "success",
              heading: "Submission Successful For CSA Seed Data Order",
              form: "CSA Seed Data Order",
              body: "Your CSA Seed Data Order has been successfully created.",
  ...
  return (
    <DynamicForm
      schema={csaSeedOrderFormSchema}
      formApiRef={formApiRef}
      onSubmit={handleSubmit}
      entityId="csa-seed-order-form"
      autosaveMs={800}
      ui={ui}
      validationSchema={csaSeedOrderFormSchema}
      defaultsSchema={csaSeedOrderFormSchema}
      output="flat"
