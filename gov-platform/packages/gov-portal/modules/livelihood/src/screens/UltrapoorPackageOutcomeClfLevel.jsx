...
import { ultraPoorPackageOutcomeClfLevelActivitySchema } from "../forms/ultrapoor-package-outcome-clf-level.schema";
...
export default function UltraPoorPackageOutcomeClfLevelActivity() {
      ...
      submitMutation.mutate(
        { method, url: Url, payload },
        {
          onSuccess: (response) => {
            hide();
            enqueue({
              message: "Ultra Poor Activity Outcome for CLF Level updated successfully",
              severity: "success",
              duration: 6000,
            });
            ...
            const params = new URLSearchParams({
              status: "success",
              heading: "Update Successful For Ultra Poor Activity Outcome Clf Level",
  ...
  return (
    <DynamicForm
      schema={ultraPoorPackageOutcomeClfLevelActivitySchema}
      formApiRef={formApiRef}
      onSubmit={handleSubmit}
      entityId="ultra-poor-package-outcome-clf-level-activity"
      autosaveMs={800}
      ui={ui}
      validationSchema={ultraPoorPackageOutcomeClfLevelActivitySchema}
      defaultsSchema={ultraPoorPackageOutcomeClfLevelActivitySchema}
      output="flat"
