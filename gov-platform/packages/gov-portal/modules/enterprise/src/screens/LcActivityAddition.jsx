...
import { lcActivityAdditionSchema } from "../forms/lc-activity-addition.schema";
...
export default function LcActivityAddition() {
  ...
  return (
    <DynamicForm
      schema={lcActivityAdditionSchema}
      formApiRef={formApiRef}
      onSubmit={handleSubmit}
      entityId="lc-activity-addition"
      autosaveMs={800}
      ui={ui}
      validationSchema={lcActivityAdditionSchema}
      defaultsSchema={lcActivityAdditionSchema}
      output="flat"
