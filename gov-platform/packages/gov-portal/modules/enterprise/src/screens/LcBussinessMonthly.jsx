...
import { lcBusinessMonthlyFormSchema } from "../forms/lc-bussines-monthly.schema";
...
export default function LcBussinessMonthly() {
  ...
  const handleSubmit = async (vals) => {
    try {
      ...
      console.log(flatFormData,"LC Monthly Data");
      show("LC Business Monthly Data Updating — please wait...");
      const payload = {
        module: "ENTERPRISE_ACTIVITY_UPDATE",
        operation: "CREATE",
        formType: "LC_MONTHLY_BUSINESS",
      ...
      submitMutation.mutate(
        { method, url: Url, payload },
        {
          onSuccess: (response) => {
            hide();
            enqueue({
              message: "LC Business Monthly Data Updating successfully.",
              severity: "success",
              duration: 6000,
            });
            ...
            const params = new URLSearchParams({
              status: "success",
              heading: "Submission Successful For LC Business Monthly Data Updating",
              form: "LC Business Monthly",
              body: "Your LC Business Monthly Data Updating has been successfully updated.",
  ...
  return (
    <DynamicForm
      schema={lcBusinessMonthlyFormSchema}
      formApiRef={formApiRef}
      onSubmit={handleSubmit}
      entityId="lc-business-monthly"
      autosaveMs={800}
      ui={ui}
      validationSchema={lcBusinessMonthlyFormSchema}
      defaultsSchema={lcBusinessMonthlyFormSchema}
      output="flat"
