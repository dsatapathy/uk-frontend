export const clfBusinessMonthlyFormSchema = {
    $schema: "fe.v1",
    id: "clf-business-monthly-form",
    version: "1.0.0",
    title: "CLF Business Monthly Form",
    sections: [
        {
            id: "lc-business-monthly-details",
            title: "CLF Business Monthly Details",
            fields: [
                /* --- Location Hierarchy --- */
                {
                    id: "district",
