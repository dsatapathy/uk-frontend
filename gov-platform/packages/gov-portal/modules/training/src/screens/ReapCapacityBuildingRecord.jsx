...
import { reapCapacityBuildingRecordSchema } from "../forms/reap-capacity-building-record.schema";
...
export default function ReapCapacityBuildingRecord() {
  ...
  const handleSubmit = async (vals) => {
    try {
      ...
      show("Adding Reap Capacity Building Record...");
      const payload = {
        module: "TRAININGS_AND_KM_DATA_UPDATE",
        operation: "CREATE",
        formType: "CAPACITY_BUILDING_RECORD",
      ...
      submitMutation.mutate(
        { method, url: Url, payload },
        {
          onSuccess: (response) => {
            hide();
            enqueue({
              message: "Reap Capacity Building Record added successfully.",
              severity: "success",
              duration: 6000,
            });
            ...
            const params = new URLSearchParams({
              status: "success",
              heading: "Submission Successful For Reap Capacity Building Record",
              form: "Reap Capacity Building Record",
              body: "Your Reap Capacity Building Record has been successfully created.",
  ...
  return (
    <DynamicForm
      schema={reapCapacityBuildingRecordSchema}
      formApiRef={formApiRef}
      onSubmit={handleSubmit}
      entityId="reap-capacity-building-record"
      autosaveMs={800}
      ui={ui}
      validationSchema={reapCapacityBuildingRecordSchema}
      defaultsSchema={reapCapacityBuildingRecordSchema}
      output="flat"
