...
import { caseStudyUploadSchema } from "../forms/case-study-upload.schema";
...
export default function CaseStudyUpload() {
  ...
  const handleSubmit = async (vals) => {
    try {
      ...
      show("Adding Case Study...");
      const payload = {
        module: "TRAININGS_AND_KM_DATA_UPDATE",
        operation: "CREATE",
        formType: "CASE_STUDY_UPLOAD",
        ...
        { method, url: Url, payload },
        {
          onSuccess: (response) => {
            ...
            const params = new URLSearchParams({
              status: "success",
              heading: "Submission Successful For Case Study Upload ",
              form: "Case Study",
              body: "Your Case Study has been successfully created.",
  ...
  return (
    <DynamicForm
      schema={caseStudyUploadSchema}
      formApiRef={formApiRef}
      onSubmit={handleSubmit}
      entityId="case-study-upload"
      autosaveMs={800}
      ui={ui}
      validationSchema={caseStudyUploadSchema}
      defaultsSchema={caseStudyUploadSchema}
      output="flat"
