...
import { farmerClimateSmartAgricultureTrainingSchema } from "../forms/farmer-climate-smart-agriculture-training.schema";
...
export default function FarmerClimateSmartAgricultureTraining() {
  ...
  const handleSubmit = async (vals) => {
    try {
      ...
      show("Adding Farmer Climate Smart Agriculture Training...");
      const payload = {
        module: "TRAININGS_AND_KM_DATA_UPDATE",
        operation: "CREATE",
        formType: "CSA_TRAINING",
      ...
      submitMutation.mutate(
        { method, url: Url, payload },
        {
          onSuccess: (response) => {
            hide();
            enqueue({
              message: "Farmer Climate Smart Agriculture Training added successfully.",
              severity: "success",
              duration: 6000,
            });
            ...
            const params = new URLSearchParams({
              status: "success",
              heading: "Submission Successful For Farmer Climate Smart Agriculture Training",
              form: "Farmer Climate Smart Agriculture Training",
              body: "Your Farmer Climate Smart Agriculture Training has been successfully created.",
  ...
  return (
    <DynamicForm
      schema={farmerClimateSmartAgricultureTrainingSchema}
      formApiRef={formApiRef}
      onSubmit={handleSubmit}
      entityId="farmer-climate-smart-agriculture-training"
      autosaveMs={800}
      ui={ui}
      validationSchema={farmerClimateSmartAgricultureTrainingSchema}
      defaultsSchema={farmerClimateSmartAgricultureTrainingSchema}
      output="flat"
