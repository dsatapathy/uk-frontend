...
const registerConfig = {
  ...
  fields: [
    { type: "text",     name: "username", label: "Enter User ID", required: true, minLength: 3, icon: "person",
      grid: { span: { xs: 12, md: 12 } } },
    { type: "text",     name: "confirmUsername", label: "Re-enter User ID", required: true, minLength: 3, icon: "person",
      grid: { span: { xs: 12, md: 12 } } },
